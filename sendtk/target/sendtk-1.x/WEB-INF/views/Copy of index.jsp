...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/js/progress-bar/number-pb.css">
    ...
    <!--[if lt IE 9]>
        ...
        <![endif]-->
    <!-- Fav and touch icons -->
    <link rel="shortcut icon" href="${pageContext.request.contextPath}/resources/ico/minus.png">
</head>
...
<body>
                ...
                <ul class="nav navbar-nav">
                    <li class="dropdown">
                        ...
                        <ul style="margin: 11px 0 0 9px;" role="menu" class="dropdown-menu dropdown-wrap">
                            <li>
                                <a href="#">
                                    <img alt="" class="img-msg img-circle" src="${pageContext.request.contextPath}/resources/images/thumb/men/1.jpg">Jhon Doe <b>Just Now</b>
                                </a>
                            </li>
                            <li class="divider"></li>
                            <li>
                                <a href="#">
                                    <img alt="" class="img-msg img-circle" src="${pageContext.request.contextPath}/resources/images/thumb/women/1.jpg">Jeniffer <b>3 Min Ago</b>
                                </a>
                            </li>
                            <li class="divider"></li>
                            <li>
                                <a href="#">
                                    <img alt="" class="img-msg img-circle" src="${pageContext.request.contextPath}/resources/images/thumb/men/2.jpg">Dave <b>2 Hours Ago</b>
                                </a>
                            </li>
                            <li class="divider"></li>
                            <li>
                                <a href="#">
                                    <img alt="" class="img-msg img-circle" src="${pageContext.request.contextPath}/resources/images/thumb/men/3.jpg"><i>Keanu</i>  <b>1 Day Ago</b>
                                </a>
                            </li>
                            <li class="divider"></li>
                            <li>
                                <a href="#">
                                    <img alt="" class="img-msg img-circle" src="${pageContext.request.contextPath}/resources/images/thumb/men/4.jpg"><i>Masashi</i>  <b>2 Mounth Ago</b>
                                </a>
                            </li>
                            <li class="divider"></li>
                            <li>
                ...
                <ul style="margin-right:0;" class="nav navbar-nav navbar-right">
                    <li>
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <img alt="" class="admin-pic img-circle" src="${pageContext.request.contextPath}/resources/images/thumb/men/10.jpg">Hi, Dave Mattew <b class="caret"></b>
                        </a>
    ...
    <div id="skin-select">
        ...
        <div class="dark">
            <form action="#">
                <span>
                    <input type="text" name="search" value="" id="id_search" class="search rounded" placeholder="Search Menu..." autofocus />
                </span>
            </form>
        </div>
        <div class="skin-part">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="driver-devider">
                                                    <img class="armada-pic img-circle" alt="" src="${pageContext.request.contextPath}/resources/images/thumb/men/14.jpg">
                                            ...
                                            <tr>
                                                ...
                                                <td class="driver-devider">
                                                    <img class="armada-pic img-circle" alt="" src="${pageContext.request.contextPath}/resources/images/thumb/men/38.jpg">
                                                    <h3>Marko Freytag</h3>
                                                    <br>
                                                    <p>Pilot</p>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="driver-devider">
                                                    <img class="armada-pic img-circle" alt="" src="${pageContext.request.contextPath}/resources/images/thumb/men/39.jpg">
                ...
                <div class="col-sm-12">
                    ...
                    <ul class="chat">
                        <li>
                            <a href="#">
                                <span>
                                    <img alt="" class="img-chat img-circle" src="${pageContext.request.contextPath}/resources/images/thumb/men/20.jpg">
                        ...
                        <li>
                            <a href="#">
                                <span>
                                    <img alt="" class="img-chat img-circle" src="${pageContext.request.contextPath}/resources/images/thumb/men/21.jpg">
                        ...
                        <li>
                            <a href="#">
                                <span>
                                    <img alt="" class="img-chat img-circle" src="${pageContext.request.contextPath}/resources/images/thumb/men/22.jpg">
                    ...
                    <ul class="chat">
                        <li>
                            <a href="#">
                                <span>
                                    <img alt="" class="img-chat img-offline img-circle" src="${pageContext.request.contextPath}/resources/images/thumb/men/23.jpg">
                                </span><b>Dave Junior</b>
                                <br><i>Last seen : 08:00 PM</i>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <span>
                                    <img alt="" class="img-chat img-offline img-circle" src="${pageContext.request.contextPath}/resources/images/thumb/women/24.jpg">
                                </span><b>Kenneth Lucas</b>
                                <br><i>Last seen : 07:21 PM</i>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <span>
                                    <img alt="" class="img-chat img-offline img-circle" src="${pageContext.request.contextPath}/resources/images/thumb/men/25.jpg">
                                </span><b>Heidi Perez</b>
                                <br><i>Last seen : 05:43 PM</i>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <span>
                                    <img alt="" class="img-chat img-offline img-circle" src="${pageContext.request.contextPath}/resources/images/thumb/women/25.jpg">
                                </span><b>Kenneth Lucas</b>
                                <br><i>Last seen : 07:21 PM</i>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <span>
                                    <img alt="" class="img-chat img-offline img-circle" src="${pageContext.request.contextPath}/resources/images/thumb/men/26.jpg">
                                </span><b>Heidi Perez</b>
                                <br><i>Last seen : 05:43 PM</i>
                            </a>
                        </li>
    ...
    <script src="${pageContext.request.contextPath}/resources/js/progress-bar/src/jquery.velocity.min.js"></script>
    <script src="${pageContext.request.contextPath}/resources/js/progress-bar/number-pb.js"></script>
    <script src="${pageContext.request.contextPath}/resources/js/progress-bar/progress-app.js"></script>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/chart/jquery.flot.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/chart/jquery.flot.resize.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/chart/realTime.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/speed/canvasgauge-coustom.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/countdown/jquery.countdown.js"></script>



    <script src="${pageContext.request.contextPath}/resources/js/jhere-custom.js"></script>
    ...
    $(window).on('load', function() {
        $('#mapContainer').jHERE({
            ...
            icon: '/controlmission/resources/assets/img/marker.png',
            anchor: {
                x: 12,
                y: 32
            },
