(function(e) {
    if (typeof e.fn.each2 == "undefined") {
        e.extend(e.fn, {
            each2: function(t) {
                var n = e([0]),
                    r = -1,
                    i = this.length;
                while (++r < i && (n.context = n[0] = this[r]) && t.call(n[0], r, n) !== false);
                return this
            }
        })
    }
...
(function(e, t) {
    ...
    function g(e, n) {
        if (e === n) return true;
        if (e === t || n === t) return false;
        if (e === null || n === null) return false;
        if (e.constructor === String) return e + "" === n + "";
        if (n.constructor === String) return n + "" === e + "";
        return false
    }
    ...
    function y(e, t, n) {
        ...
        r = e.split(t);
        for (i = 0, s = r.length; i < s; i = i + 1) r[i] = n(r[i]);
        return r
    }
    ...
    function E(n) {
        n.on("mousemove", function(n) {
            var r = u;
            if (r === t || r.x !== n.pageX || r.y !== n.pageY) {
                e(n.target).trigger("mousemove-filtered", n)
            }
        })
    }
    ...
    function T(e) {
        ...
        window.setTimeout(function() {
            var t = e[0],
                ...
                r;
            e.focus();
            var i = t.offsetWidth > 0 || t.offsetHeight > 0;
            if (i && t === document.activeElement) {
    ...
    function O(e, t, n, r) {
        var i = d(e.toUpperCase()).indexOf(d(t.toUpperCase())),
            s = t.length;
        if (i < 0) {
            n.push(r(e));
            return
    ...
    function _(n) {
        ...
        return function(a) {
            ...
            r = window.setTimeout(function() {
                ...
                if (i && typeof i.abort === "function") {
                    i.abort()
                }
                if (n.params) {
                    if (e.isFunction(n.params)) {
                        e.extend(c, n.params.call(u))
                    } else {
                        e.extend(c, n.params)
                    }
                }
        ...
        return function(t) {
            ...
            o = function(n, i) {
                ...
                if (n.children) {
                    u = {};
                    for (a in n) {
                        if (n.hasOwnProperty(a)) u[a] = n[a]
                    }
                    u.children = [];
                    e(n.children).each2(function(e, t) {
                        o(t, u.children)
                    });
                    if (u.children.length || t.matcher(r, s(u), n)) {
                        i.push(u)
                    }
                } else {
                    if (t.matcher(r, s(n), n)) {
                        i.push(n)
                    }
                }
            };
    ...
    n = q(Object, {
        ...
        init: function(n) {
            ...
            this.id = n.id;
            if (n.element.data("select2") !== t && n.element.data("select2") !== null) {
                n.element.data("select2").destroy()
            }
            ...
            this.containerId = "s2id_" + (n.element.attr("id") || "autogen" + s());
            ...
            this.container.css(B(n.containerCss, this.opts.element));
            this.container.addClass(B(n.containerCssClass, this.opts.element));
            ...
            this.dropdown.addClass(B(n.dropdownCssClass, this.opts.element));
            ...
            n.element.prop("autofocus", false);
        ...
        destroy: function() {
            var e = this.opts.element,
                ...
                r = this;
            this.close();
            if (e.length && e[0].detachEvent && r._sync) {
                e.each(function() {
                    if (r._sync) {
                        this.detachEvent("onpropertychange", r._sync)
                    }
                })
            }
            ...
            if (n !== t) {
                ...
                n.liveRegion.remove();
                n.dropdown.remove();
                e.show().removeData("select2").off(".select2").prop("autofocus", this.autofocus || false);
            ...
            I.call(this, "container", "liveRegion", "dropdown", "results", "search")
        },
        optionToData: function(e) {
            if (e.is("option")) {
                return {
                    ...
                    locked: g(e.attr("locked"), "locked") || g(e.data("locked"), true)
                }
        ...
        prepareOpts: function(n) {
            ...
            n = e.extend({}, {
                populateResults: function(r, i, o) {
                    var u, f = this.opts.id,
                        l = this.liveRegion;
                    u = function(r, i, c) {
                        var h, p, d, v, m, g, y, b, w, E;
                        r = n.sortResults(r, i, o);
                        var S = [];
                        for (h = 0, p = r.length; h < p; h = h + 1) {
                            d = r[h];
                            m = d.disabled === true;
                            v = !m && f(d) !== t;
                            g = d.children && d.children.length > 0;
                            y = e("<li></li>");
                            y.addClass("select2-results-dept-" + c);
                            y.addClass("select2-result");
                            y.addClass(v ? "select2-result-selectable" : "select2-result-unselectable");
                            if (m) {
                                y.addClass("select2-disabled")
                            }
                            if (g) {
                                y.addClass("select2-result-with-children")
                            }
                            y.addClass(a.opts.formatResultCssClass(d));
                            y.attr("role", "presentation");
                            b = e(document.createElement("div"));
                            b.addClass("select2-result-label");
                            b.attr("id", "select2-result-label-" + s());
                            b.attr("role", "option");
                            E = n.formatResult(d, b, o, a.opts.escapeMarkup);
                            if (E !== t) {
                                b.html(E);
                                y.append(b)
                            }
            ...
            if (i) {
                n.query = this.bind(function(e) {
                    ...
                    u = function(t, n) {
                        var r;
                        if (t.is("option")) {
                            if (e.matcher(i, t.text(), t)) {
                                n.push(a.optionToData(t))
                            }
                    ...
                    s = r.children();
                    if (this.getPlaceholder() !== t && s.length > 0) {
                        o = this.getPlaceholderOption();
                        if (o) {
                            s = s.not(o)
                        }
                    }
                ...
                if (!("query" in n)) {
                    if ("ajax" in n) {
                        u = n.element.data("ajax-url");
                        if (u && u.length > 0) {
                            n.ajax.url = u
                        }
                        n.query = _.call(n.element, n.ajax)
                    } else if ("data" in n) {
                        n.query = D(n.data)
                    } else if ("tags" in n) {
                        n.query = P(n.tags);
                        if (n.createSearchChoice === t) {
                            n.createSearchChoice = function(t) {
                                return {
                                    id: e.trim(t),
                                    text: e.trim(t)
                                }
                        ...
                        if (n.initSelection === t) {
                            n.initSelection = function(t, r) {
                                var i = [];
                                e(y(t.val(), n.separator, n.transformVal)).each(function() {
                                    var t = {
                                            id: this,
                                            text: this
                                        },
                                        r = n.tags;
                                    if (e.isFunction(r)) r = r();
                                    e(r).each(function() {
                                        if (g(this.id, t.id)) {
                                            t = this;
                                            return false
            ...
            if (n.createSearchChoicePosition === "top") {
                n.createSearchChoicePosition = function(e, t) {
                    e.unshift(t)
                }
            } else if (n.createSearchChoicePosition === "bottom") {
                n.createSearchChoicePosition = function(e, t) {
                    e.push(t)
                }
            } else if (typeof n.createSearchChoicePosition !== "function") {
        ...
        monitorSource: function() {
            ...
            this._sync = this.bind(function() {
                ...
                if (e === t) e = false;
                this.enable(!e);
                var r = n.prop("readonly");
                if (r === t) r = false;
                this.readonly(r);
                if (this.container) {
                    A(this.container, this.opts.element, this.opts.adaptContainerCssClass);
                    this.container.addClass(B(this.opts.containerCssClass, this.opts.element))
                }
                if (this.dropdown) {
                    A(this.dropdown, this.opts.element, this.opts.adaptDropdownCssClass);
                    this.dropdown.addClass(B(this.opts.dropdownCssClass, this.opts.element))
                }
            });
            if (n.length && n[0].attachEvent) {
                n.each(function() {
                    this.attachEvent("onpropertychange", i._sync)
                })
            }
        ...
        positionDropdown: function() {
            var t = this.dropdown,
                n = this.container,
                r = n.offset(),
                i = n.outerHeight(false),
                s = n.outerWidth(false),
                o = t.outerHeight(false),
                u = e(window),
                a = u.width(),
                l = u.height(),
                c = u.scrollLeft() + a,
                ...
                d = r.left,
                v = p + o <= h,
                m = r.top - o >= u.scrollTop(),
                g = t.outerWidth(false),
                y = function() {
                    return d + g <= c
                },
                b = function() {
                    return r.left + c + n.outerWidth(false) > g
                },
                w = t.hasClass("select2-drop-above"),
                E, S, x, T, N;
            if (w) {
                S = true;
                if (!m && v) {
            ...
            if (x) {
                ...
                i = this.container.outerHeight(false);
                s = this.container.outerWidth(false);
                o = t.outerHeight(false);
                c = u.scrollLeft() + a;
                h = u.scrollTop() + l;
                p = r.top + i;
            ...
            if (this.opts.dropdownAutoWidth) {
                N = e(".select2-results", t)[0];
                t.addClass("select2-drop-auto-width");
                t.css("width", "");
                g = t.outerWidth(false) + (N.scrollHeight === N.clientHeight ? 0 : f.width);
                g > s ? s = g : g = s;
                o = t.outerHeight(false)
            } else {
            ...
            if (!y() && b()) {
                d = r.left + this.container.outerWidth(false) - g
            }
            T = {
                left: d,
                width: s
            ...
            T = e.extend(T, B(this.opts.dropdownCss, this.opts.element));
            t.css(T)
        },
        shouldOpen: function() {
            var t;
        ...
        open: function() {
            ...
            this.opening();
            a.on("mousemove.select2Event", function(e) {
                u.x = e.pageX;
                u.y = e.pageY
            });
            return true
        ...
        opening: function() {
            ...
            if (s.length === 0) {
                ...
                s.on("mousedown touchstart click", function(t) {
                    p(s);
                    var n = e("#select2-drop"),
                        r;
                    if (n.length > 0) {
                        r = n.data("select2");
                        if (r.opts.selectOnBlur) {
                            r.selectHighlighted({
                                noFocus: true
                            })
                        }
        ...
        getMaximumSelectionSize: function() {
            return B(this.opts.maximumSelectionSize, this.opts.element)
        },
        ensureHighlightVisible: function() {
            ...
            i = e(n[r]);
            f = (i.offset() || {}).top || 0;
            s = f + i.outerHeight(true);
            if (r === n.length - 1) {
                a = t.find("li.select2-more-results");
                if (a.length > 0) {
                    s = a.offset().top + a.outerHeight(true)
                }
            }
            o = t.offset().top + t.outerHeight(false);
            if (s > o) {
                t.scrollTop(t.scrollTop() + (s - o))
            }
            u = f - t.offset().top;
            if (u < 0 && i.css("display") != "none") {
        ...
        highlight: function(t) {
            ...
            if (arguments.length === 0) {
                return v(n.filter(".select2-highlighted")[0], n.get())
            }
            ...
            if (n <= this.opts.loadMorePadding) {
                ...
                this.opts.query({
                    ...
                    callback: this.bind(function(n) {
                        ...
                        i.postprocessResults(n, false, false);
                        if (n.more === true) {
                            t.detach().appendTo(e).html(i.opts.escapeMarkup(B(i.opts.formatLoadMore, i.opts.element, r + 1)));
                            window.setTimeout(function() {
                                i.loadMoreIfNeeded()
                            }, 10)
                        } else {
        ...
        updateResults: function(n) {
            function h() {
                ...
                u.positionDropdown();
                if (i.find(".select2-no-results,.select2-selection-limit,.select2-searching").length) {
                    u.liveRegion.text(i.text())
                } else {
                    u.liveRegion.text(u.opts.formatMatches(i.find('.select2-result-selectable:not(".select2-selected")').length))
                }
            }
            ...
            var r = this.search,
                ...
                c;
            if (n !== true && l && g(f, l)) return;
            e.data(this.container, "select2-last-term", f);
            if (n !== true && (this.showSearchInput === false || !this.opened())) {
                return
            }
            c = ++this.queryCount;
            ...
            if (d >= 1) {
                ...
                if (e.isArray(o) && o.length >= d && H(s.formatSelectionTooBig, "formatSelectionTooBig")) {
                    p("<li class='select2-selection-limit'>" + B(s.formatSelectionTooBig, s.element, d) + "</li>");
                    return
                }
            }
            if (r.val().length < s.minimumInputLength) {
                if (H(s.formatInputTooShort, "formatInputTooShort")) {
                    p("<li class='select2-no-results'>" + B(s.formatInputTooShort, s.element, r.val(), s.minimumInputLength) + "</li>")
                } else {
                    p("")
                }
                if (n && this.showSearch) this.showSearch(true);
                return
            }
            if (s.maximumInputLength && r.val().length > s.maximumInputLength) {
                if (H(s.formatInputTooLong, "formatInputTooLong")) {
                    p("<li class='select2-no-results'>" + B(s.formatInputTooLong, s.element, r.val(), s.maximumInputLength) + "</li>")
                } else {
                    p("")
                }
                return
            }
            if (s.formatSearching && this.findHighlightableChoices().length === 0) {
                p("<li class='select2-searching'>" + B(s.formatSearching, s.element) + "</li>")
            }
            ...
            s.query({
                ...
                callback: this.bind(function(o) {
                    ...
                    if (o.hasError !== t && H(s.formatAjaxError, "formatAjaxError")) {
                        p("<li class='select2-ajax-error'>" + B(s.formatAjaxError, s.element, o.jqXHR, o.textStatus, o.errorThrown) + "</li>");
                        return
                    }
                    this.context = o.context === t ? null : o.context;
                    if (this.opts.createSearchChoice && r.val() !== "") {
                        a = this.opts.createSearchChoice.call(u, r.val(), o.results);
                        if (a !== t && a !== null && u.id(a) !== t && u.id(a) !== null) {
                            if (e(o.results).filter(function() {
                                    return g(u.id(this), u.id(a))
                                }).length === 0) {
                                this.opts.createSearchChoicePosition(o.results, a)
                            }
                        }
                    }
                    if (o.results.length === 0 && H(s.formatNoMatches, "formatNoMatches")) {
                        p("<li class='select2-no-results'>" + B(s.formatNoMatches, s.element, r.val()) + "</li>");
                        this.showSearch(r.val());
                        return
                    }
                    i.empty();
                    ...
                    if (o.more === true && H(s.formatLoadMore, "formatLoadMore")) {
                        i.append("<li class='select2-more-results'>" + s.escapeMarkup(B(s.formatLoadMore, s.element, this.resultsPage)) + "</li>");
                        window.setTimeout(function() {
                            u.loadMoreIfNeeded()
                        }, 10)
                    }
        ...
        getPlaceholderOption: function() {
            if (this.select) {
                ...
                if (this.opts.placeholderOption !== t) {
                    return this.opts.placeholderOption === "first" && n || typeof this.opts.placeholderOption === "function" && this.opts.placeholderOption(this.select)
                } else if (e.trim(n.text()) === "" && n.val() === "") {
                    return n
                }
            }
        },
        initContainerWidth: function() {
            function n() {
                ...
                if (this.opts.width === "off") {
                    ...
                    return null
                } else if (e.isFunction(this.opts.width)) {
    ...
    r = q(n, {
        ...
        initContainer: function() {
            ...
            o = e("label[for='" + this.opts.element.attr("id") + "']");
            ...
            this.opts.element.attr("title", u || o.text());
            ...
            this.search.on("keydown", this.bind(function(e) {
                ...
                if (e.which === l.PAGE_UP || e.which === l.PAGE_DOWN) {
                    C(e);
                    return
                }
                switch (e.which) {
                    case l.UP:
                    case l.DOWN:
                        this.moveHighlight(e.which === l.UP ? -1 : 1);
                        C(e);
                        return;
                    case l.ENTER:
                        this.selectHighlighted();
            ...
            this.focusser.on("keydown", this.bind(function(e) {
                if (!this.isInterfaceEnabled()) return;
                if (e.which === l.TAB || l.isControl(e) || l.isFunctionKey(e) || e.which === l.ESC) {
                    return
                }
                if (this.opts.openOnEnter === false && e.which === l.ENTER) {
                    C(e);
                    return
                }
                if (e.which == l.DOWN || e.which == l.UP || e.which == l.ENTER && this.opts.openOnEnter) {
                    if (e.altKey || e.ctrlKey || e.shiftKey || e.metaKey) return;
                    this.open();
                    C(e);
                    return
                }
                if (e.which == l.DELETE || e.which == l.BACKSPACE) {
        ...
        isPlaceholderOptionSelected: function() {
            var e;
            if (this.getPlaceholder() === t) return false;
            return (e = this.getPlaceholderOption()) !== t && e.prop("selected") || this.opts.element.val() === "" || this.opts.element.val() === t || this.opts.element.val() === null
        },
        prepareOpts: function() {
            ...
            if (t.element.get(0).tagName.toLowerCase() === "select") {
                ...
                t.initSelection = t.initSelection || function(n, r) {
                    var i = n.val();
                    var s = null;
                    t.query({
                        ...
                        callback: !e.isFunction(r) ? e.noop : function() {
                            r(s)
                        }
                    })
                }
        ...
        getPlaceholder: function() {
            if (this.select) {
                if (this.getPlaceholderOption() === t) {
                    return t
                }
            }
        ...
        postprocessResults: function(e, t, n) {
            ...
            this.findHighlightableChoices().each2(function(e, t) {
                if (g(i.id(t.data("select2-data")), i.opts.element.val())) {
                    r = e;
                    return false
                }
            });
        ...
        updateSelection: function(e) {
            ...
            n.empty();
            if (e !== null) {
                r = this.opts.formatSelection(e, n, this.opts.escapeMarkup)
            }
            if (r !== t) {
                n.append(r)
            }
            ...
            if (this.opts.allowClear && this.getPlaceholder() !== t) {
    ...
    i = q(n, {
        ...
        prepareOpts: function() {
            ...
            if (t.element.get(0).tagName.toLowerCase() === "select") {
                ...
                t.initSelection = t.initSelection || function(n, r) {
                    var i = y(n.val(), t.separator, t.transformVal);
                    var s = [];
                    t.query({
        ...
        initContainer: function() {
            ...
            this.selection = n = this.container.find(t);
            var r = this;
            ...
            this.search.on("keydown", this.bind(function(e) {
                if (!this.isInterfaceEnabled()) return;
                ++this.keydowns;
                var t = n.find(".select2-search-choice-focus");
                var r = t.prev(".select2-search-choice:not(.select2-locked)");
                var i = t.next(".select2-search-choice:not(.select2-locked)");
                var s = N(this.search);
                if (t.length && (e.which == l.LEFT || e.which == l.RIGHT || e.which == l.BACKSPACE || e.which == l.DELETE || e.which == l.ENTER)) {
                    var o = t;
                    if (e.which == l.LEFT && r.length) {
                        o = r
                    } else if (e.which == l.RIGHT) {
                        o = i.length ? i : null
                    } else if (e.which === l.BACKSPACE) {
                        if (this.unselect(t.first())) {
                            this.search.width(10);
                            o = r.length ? r : i
                        }
                    } else if (e.which == l.DELETE) {
                        if (this.unselect(t.first())) {
                            this.search.width(10);
                            o = i.length ? i : null
                        }
                    ...
                    return
                } else if ((e.which === l.BACKSPACE && this.keydowns == 1 || e.which == l.LEFT) && s.offset == 0 && !s.length) {
                    this.selectChoice(n.find(".select2-search-choice:not(.select2-locked)").last());
                    C(e);
                    return
                } else {
                ...
                if (e.which === l.TAB || l.isControl(e) || l.isFunctionKey(e) || e.which === l.BACKSPACE || e.which === l.ESC) {
                    return
                }
                if (e.which === l.ENTER) {
        ...
        clearSearch: function() {
            ...
            if (e !== t && this.getVal().length === 0 && this.search.hasClass("select2-focused") === false) {
                this.search.val(e).addClass("select2-default");
                this.search.width(n > 0 ? n : this.container.css("width"))
            } else {
        ...
        addSelectedChoice: function(n) {
            var r = !n.locked,
                i = e("<li class='select2-search-choice'>" + "    <div></div>" + "    <a href='#' class='select2-search-choice-close' tabindex='-1'></a>" + "</li>"),
            ...
            if (f != t) {
                o.find("div").replaceWith(e("<div></div>").html(f))
            }
            ...
            if (r) {
                o.find(".select2-search-choice-close").on("mousedown", C).on("click dblclick", this.bind(function(t) {
                    if (!this.isInterfaceEnabled()) return;
        ...
        postprocessResults: function(e, t, n) {
            ...
            if (this.highlight() == -1 && n !== false && this.opts.closeOnSelect === true) {
                o.highlight(0)
            }
            if (!this.opts.createSearchChoice && !i.filter(".select2-result:not(.select2-selected)").length > 0) {
                if (!e || e && !e.more && this.results.find(".select2-no-results").length === 0) {
                    if (H(o.opts.formatNoMatches, "formatNoMatches")) {
                        this.results.append("<li class='select2-no-results'>" + B(o.opts.formatNoMatches, o.opts.element, o.search.val()) + "</li>")
                    }
                }
            }
        },
        getMaxSearchWidth: function() {
            return this.selection.width() - b(this.search)
        },
        resizeSearch: function() {
            var e, t, n, r, i, s = b(this.search);
            e = L(this.search) + 10;
        ...
        getVal: function() {
            ...
            if (this.select) {
                ...
                return y(e, this.opts.separator, this.opts.transformVal)
            }
        },
        setVal: function(t) {
            var n;
        ...
        buildChangeDetails: function(e, t) {
            ...
            for (var n = 0; n < t.length; n++) {
                for (var r = 0; r < e.length; r++) {
                    if (g(this.opts.id(t[n]), this.opts.id(e[r]))) {
                        t.splice(n, 1);
                        if (n > 0) {
                            n--
                        }
        ...
        val: function(n, r) {
            ...
            if (this.select) {
                ...
                this.opts.initSelection(this.opts.element, function(t) {
                    ...
                    s.clearSearch();
                    if (r) {
                        s.triggerChange(s.buildChangeDetails(i, s.data()))
                    }
                })
            }
            this.clearSearch()
        ...
        data: function(t, n) {
            ...
            if (arguments.length === 0) {
                ...
                this.clearSearch();
                if (n) {
                    this.triggerChange(this.buildChangeDetails(s, this.data()))
                }
            }
        }
    });
    e.fn.select2 = function() {
        var n = Array.prototype.slice.call(arguments, 0),
            r, i, s, o, u, a = ["val", "destroy", "opened", "open", "close", "focus", "isFocused", "container", "dropdown", "onSortStart", "onSortEnd", "enable", "disable", "readonly", "positionDropdown", "data", "search"],
            f = ["opened", "isFocused", "container", "dropdown"],
            l = ["val", "data"],
            c = {
        ...
        this.each(function() {
            if (n.length === 0 || typeof n[0] === "object") {
                ...
                if (s === "container") {
                    ...
                    if (c[s]) s = c[s];
                    o = i[s].apply(i, n.slice(1))
                }
                if (v(n[0], f) >= 0 || v(n[0], l) >= 0 && n.length == 1) {
                    return false
                }
            } else {
    ...
    e.fn.select2.defaults = {
        ...
        text: function(t) {
            if (t && this.data && this.data.text) {
                if (e.isFunction(this.data.text)) {
                    return this.data.text(t)
                } else {
                    return t[this.data.text]
                }
            } else {
                return t.text
            }
        ...
        matcher: function(e, t) {
            return d("" + t).toUpperCase().indexOf(d("" + e).toUpperCase()) >= 0
        },
        separator: ",",
        tokenSeparators: [],
        tokenizer: F,
    ...
    e.fn.select2.locales["en"] = {
        ...
        formatAjaxError: function(e, t, n) {
