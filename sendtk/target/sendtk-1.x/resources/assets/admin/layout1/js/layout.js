...
function handleboxedLayout() {
    ...
    if ($('body').hasClass('boxed')) {
        ...
        if (!$('body').hasClass('sidebar-top') && windowWidth > 1220)  {
            ...
            $.backstretch(["/sendtk/assets/global/images/gallery/bg1.jpg", "/sendtk/assets/global/images/gallery/bg2.jpg", "/sendtk/assets/global/images/gallery/bg3.jpg", "/sendtk/assets/global/images/gallery/bg4.jpg"], 
